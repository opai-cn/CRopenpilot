...
from opendbc.car.hyundai.values import DBC, HyundaiFlags, HyundaiExFlags
...
class RadarInterface(RadarInterfaceBase):
  def __init__(self, CP):
    ...
    if self.canfd:
      if CP.exFlags & HyundaiExFlags.RADAR_GROUP1.value:
    ...
    self.radar_tracks = Params().get_bool("RadarTrackEnable")
    ...
    self.vLead_filter = StreamingMovingAverage(13) # for SCC radar 0.1 unit
    self.vRel_last = 0
    self.dRel_last = 0
